...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double WHEEL_RADIUS = 0.875; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    public static double LATERAL_DISTANCE = 9.65; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -0.5; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, frontEncoder;

    public static double X_MULTIPLIER = 0.855; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.85; // Multiplier in the Y direction
