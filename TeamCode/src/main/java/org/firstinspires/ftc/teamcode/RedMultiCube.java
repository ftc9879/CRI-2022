...
public class RedMultiCube extends LinearOpMode {
    OpenCvWebcam webcam; 
...
// Initialize the gyro
        ...
        if(position == "left"){            
            ...
            waiting(.5);
            moveStraightTimer('f',300,-90,.25,2);
            waiting(.25);
            armMove('u','h',1);
            waiting(.25);
            moveStraight('b',-3650,-90,.75);
            waiting(.25);
            pointTurn('l',-10,.4);
            waiting(.25);
            moveStraight('f',1200,0,.5);
            ...
            waiting(.75);
            intakeMotor.setPower(0);
            moveStraight('b',-1350,0,.75);
            waiting(.25);
            pointTurn('r',-80,.4);
            moveStraight('f',2750,-90,.75);
            armMove('d','b',.5);
            ...
            pointTurn('l',25,.5);
            waiting(0.25);
            moveStraight('f',650,35,.25);
            waiting(0.75);
            intakeMotor.setPower(-.5);
            waiting(0.75);
            intakeMotor.setPower(0);
            waiting(.25);
            moveStraight('b',-500,45,.5);
            waiting(.5);
            pointTurn('r',10,.4);
            waiting(.25);
            armMove('d','m',1);
            waiting(.25);
            moveStraight('b',-1500,0,.5);
            waiting(.25);
            pointTurn('r',-80,.4);
            waiting(.25);
             moveStraight('f',1200,-90,.75);
