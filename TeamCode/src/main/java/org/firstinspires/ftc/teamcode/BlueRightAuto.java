...
// Initialize the gyro
        ...
        if(position == "left"){
            armMove('d','l',.75);
           moveStraight('f',2700,0,.5);
            waiting(0.25);
            pointTurn('l',80,.40);
            waiting(0.25);
            moveStraight('f',100,90,.25);
            waiting(1);
            ...
            moveStraight('f',850,90,.4);
            waiting(1);
            intakeMotor.setPower(-.5);
            waiting(1);
            intakeMotor.setPower(0);
            waiting(.25);
            moveStraight('b',-1550,90,.5);
            waiting(.25);
            ...
            moveStraight('b',-2400,0,.5);
            waiting(.25);
            moveStraightTimer('b',-250,0,.25,1.2);
            deliveryMotor.setPower(0.5);
            waiting(4);
            waiting(.25);
            moveStraight('f',1350,0,.5);
            waiting(0.25);
            armMove('d','b',.5);
        }
        else { 
            ...
            moveStraight('f',1300,90,.4);
            waiting(.25);
            intakeMotor.setPower(-.5);
            waiting(1);
            intakeMotor.setPower(0);
            waiting(.25);
            moveStraight('b',-2000,90,.5);
            waiting(.25);
            ...
            moveStraight('b',-2400,0,.5);
            waiting(.25);
            moveStraightTimer('b',-300,0,.25,1.4);
            deliveryMotor.setPower(0.5);
            waiting(4);
            waiting(.25);
            moveStraight('f',1350,0,.5);
