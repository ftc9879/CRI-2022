...
public class BlueMultiCube extends LinearOpMode {
    OpenCvWebcam webcam; 
...
// Initialize the gyro
        ...
        if(position == "left"){            
            armMove('d','l',.75);
            waiting(0.25);
            moveStraight('f',1200,0,.5);
            waiting(0.25);
            pointTurn('r',-35,.5);
            waiting(0.25);
            moveStraight('f',200,-45,.25);
            waiting(0.25);
            intakeMotor.setPower(-.5);
            waiting(0.75);
            intakeMotor.setPower(0);
            waiting(.25);
            moveStraight('b',-200,-45,.5);
            waiting(.5);
            pointTurn('l',-10,.4);
            waiting(.25);
            armMove('u','m',1);
            waiting(.25);
            moveStraight('b',-1300,0,.5);
            waiting(.25);
            pointTurn('l',80,.4);
            waiting(.25);
             moveStraight('f',1200,90,.75);
            armMove('d','p',.5);
            moveStraight('f',1000,90,.5);
            waiting(.75);
            intakeMotor.setPower(1);
            waiting(.5);
            moveStraight('f',300,90,.40);
            waiting(.25);
            armMove('u','h',1);
            waiting(.25);
            moveStraight('b',-3700,90,.75);
            waiting(.25);
            pointTurn('r',10,.4);
            waiting(.25);
            moveStraight('f',1200,0,.5);
            ...
            waiting(.75);
            intakeMotor.setPower(0);
            moveStraight('b',-1400,0,.75);
            waiting(.25);
            pointTurn('l',80,.4);
            moveStraight('f',2900,90,.75);
            armMove('d','b',.5);
            ...
            armMove('u','h',1);
            waiting(0.25);
            moveStraight('f',600,0,.5);
            waiting(0.25);
            pointTurn('r',-22,.5);
            waiting(0.25);
            moveStraight('f',1100,-32,.35);
            waiting(0.25);
            intakeMotor.setPower(-.5);
            waiting(0.75);
            intakeMotor.setPower(0);
            waiting(.25);
            moveStraight('b',-600,-32,.5);
            waiting(.5);
            pointTurn('l',-10,.4);
            waiting(.25);
            armMove('d','m',1);
            waiting(.25);
            moveStraight('b',-1100,0,.5);
            waiting(.25);
            pointTurn('l',80,.4);
            waiting(.25);
             moveStraight('f',1200,90,.75);
    ...
    void armMove(final char ud, final char lmh, final double motorPower){
        if(ud == 'u'){
            if(lmh == 'l'){
                ...
                while(lift.getCurrentPosition()<1050){
                // used gear 1000 
                lift.setPower(motorPower);
                }
            }
            else if(lmh == 'h'){
                while(lift.getCurrentPosition()<1400){
                // used gear 1300
                lift.setPower(motorPower);
